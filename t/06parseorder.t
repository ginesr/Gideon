...
my $config_array = Gideon->params->validate_sorting( [ { desc => 'name' }, { asc => [ 'iso', 'name' ] } ], 'skip_meta_check' );
...
my $config_hash = Gideon->params->validate_sorting( { asc => [ 'iso', 'name' ], desc => 'name' }, 'skip_meta_check' );
