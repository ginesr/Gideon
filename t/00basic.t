...
is( Basic::Gideon->get_store_destination(), 'destination', 'Get store destination' );
is( Basic::Gideon->get_store_args(),        'String!',     'Get store args' );
is( Basic::Gideon->get_store_id(),          'test',        'Get Store id' );
